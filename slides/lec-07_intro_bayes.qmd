...
The conditional probability of A given B is the conditional probality ob B given A scaled by the relative probability of A compared to B.
...
|:-------------|:----------:|:----------:|:----:|
|H~0~ is true  |a           |b           |a + b |
|H~0~ is false |c           |d           |c + d |
|Total         |a+c         |b+d         |N     |


[a]{.emph} type I error 

[d]{.emph} type II error (1-power)

[False positive]{.emph} $P[H_0\ true | Reject\ H_0] = \frac{a}{b+c}$

\

[False negative]{.emph}: $P[H_0\ true | Reject\ H_0] = \frac{a}{b+c}$
...
* Sensitivity: **P[test + | Covid ] = `r (1 - type_2) * 100`**
* Specificity: P[test + | Healthy ] = `r (1 - type_1) * 100`
...
* imagine running your experiment again and again.
* or make an argument like this:
  ...
  * On day 3 ... [the same]. and so on constructing confidence intervals
...
* ... neither version says anything about whether your data is
in the 95% or the 5%
